public class B4_MiltonFilter extends World
{
   ...
   public void go()
   {
      ...
      {
         for(int col=60; col<445; col++)    //*** this is using new getBackgroun
         {
...
//            {
//               plane.setPixelColor(65,180,100);
//            }

            if((red>150 && green>50 && blue>=0) && (red<256 && green<=255 && blue<30))
            {
               plane.setPixelColor(25,200,35);
            }
         }
      }
   }
